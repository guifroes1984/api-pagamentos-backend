package br.com.guifroes1984.api.pagamentos.security;
...
public class AppUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		Usuario usuario = usuarioOtional.orElseThrow(() -> new UsernameNotFoundException("Usuario e/ou senha incorretas"));
